...
var skyboxMesh;
var planetSpriteTexture = THREE.ImageUtils.loadTexture("./assets/planet.png");
var asteroidSpriteTexture = THREE.ImageUtils.loadTexture("./assets/asteroid.png");
...
window.onload = function(){
  ...
  addNumberedBodies('./assets/numberedBodies.dat');
  addUnumberedBodies('./assets/unnumberedBodies.dat');
...
function createSkybox(){
  ...
  var texture = new THREE.ImageUtils.loadTexture('./assets/milky_way.jpg');
...
function createSun(){
  var flareTexture = THREE.ImageUtils.loadTexture("./assets/flare.png");
