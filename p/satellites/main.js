...
window.onload = function(){
  ...
  createEarthMesh();
  loadTLEFile("assets/gps-ops.txt");
  loadTLEFile("assets/iridium.txt");
  render();
}
...
function createEarthMesh(){
    ...
    var day = THREE.ImageUtils.loadTexture("assets/8081-earthmap4k.jpg");
  //  var night = THREE.ImageUtils.loadTexture("assets/earthlights1k.jpg");

  //  var day = THREE.ImageUtils.loadTexture("assets/8081-earthmap4k.jpg");
  //  var night = THREE.ImageUtils.loadTexture("assets/8081-earthlights4k.jpg");
  //  var bump = THREE.ImageUtils.loadTexture("assets/earthbump1k.jpg");
  //  var specular = THREE.ImageUtils.loadTexture("assets/earthspec1k.jpg");
  ...
  var cloudMaterial = new THREE.MeshBasicMaterial({
    map: new THREE.ImageUtils.loadTexture("assets/fair_clouds_8k.jpg"),
    //side: THREE.DoubleSide,
    opacity: 0.2,
    //alphaMap: new THREE.ImageUtils.loadTexture("assets/earthcloudmaptrans.jpg"),
    transparent: true,
    depthWrite: false
  })
