...
var g_B5JupiterCoefficients =
[ 
  [ 1,  0.09, 522.58 ]
];

var g_R0JupiterCoefficients =
[ 
  [ 520887429,  0,          0 ],
...
function venus() {
 //   JD =2448976.5
    ...
    var B = [];
    var R = [];
    L[0]=calcSeries(g_L0VenusCoefficients, T);
    L[1]=calcSeries(g_L1VenusCoefficients, T);
    L[2]=calcSeries(g_L2VenusCoefficients, T);
    L[3]=calcSeries(g_L3VenusCoefficients, T);
    L[4]=calcSeries(g_L4VenusCoefficients, T);
    L[5]=calcSeries(g_L5VenusCoefficients, T);
    
    B[0]=calcSeries(g_B0VenusCoefficients, T);
    B[1]=calcSeries(g_B1VenusCoefficients, T);
    B[2]=calcSeries(g_B2VenusCoefficients, T);
    B[3]=calcSeries(g_B3VenusCoefficients, T);
    B[4]=calcSeries(g_B4VenusCoefficients, T);
    
    R[0]=calcSeries(g_R0VenusCoefficients, T);
    R[1]=calcSeries(g_R1VenusCoefficients, T);
    R[2]=calcSeries(g_R2VenusCoefficients, T);
    R[3]=calcSeries(g_R3VenusCoefficients, T);
    R[4]=calcSeries(g_R4VenusCoefficients, T);
    
    helio.lon = calcCoord(L, T);
    helio.lat = calcCoord(B, T);
    dist = calcCoord(R, T);
    drawPlanet(helio, dist, e);
}
...
function jupiter() {
 //   JD =2448976.5
    ...
    var B = [];
    var R = [];
    L[0]=calcSeries(g_L0MercuryCoefficients, T);
    L[1]=calcSeries(g_L1MercuryCoefficients, T);
    L[2]=calcSeries(g_L2MercuryCoefficients, T);
    L[3]=calcSeries(g_L3MercuryCoefficients, T);
    L[4]=calcSeries(g_L4MercuryCoefficients, T);
    L[5]=calcSeries(g_L5MercuryCoefficients, T);
    
    B[0]=calcSeries(g_B0MercuryCoefficients, T);
    B[1]=calcSeries(g_B1MercuryCoefficients, T);
    B[2]=calcSeries(g_B2MercuryCoefficients, T);
    B[3]=calcSeries(g_B3MercuryCoefficients, T);
    B[4]=calcSeries(g_B4MercuryCoefficients, T);
    
    R[0]=calcSeries(g_R0MercuryCoefficients, T);
    R[1]=calcSeries(g_R1MercuryCoefficients, T);
    R[2]=calcSeries(g_R2MercuryCoefficients, T);
    R[3]=calcSeries(g_R3MercuryCoefficients, T);
    
    
}

function calcSeries(s, tau){
    var T= 0;
    for(var i =0; i<s.length; i++){
        T+=s[i][0]*Math.cos(s[i][1]+s[i][2]*tau);
    }
    return T;
}
